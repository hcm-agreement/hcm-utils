...
public class Helpers
{
    ...
    internal static PointToLineInput ParsePointToLineMultiCalc(List<string> inputList) => new(
            ...
            double.TryParse(inputList[13], CultureInfo.InvariantCulture, out var distanceOverSea) ? distanceOverSea : null,
            ...
            double.TryParse(inputList[18], CultureInfo.InvariantCulture, out var permissibleFieldStrength) ? permissibleFieldStrength : null,
    ...
    internal static PointToPointInput ParsePointToPointMultiCalc(List<string> inputList) => new(
            ...
            double.TryParse(inputList[20], CultureInfo.InvariantCulture, out var permissibleFieldStrength) ? permissibleFieldStrength : null,
