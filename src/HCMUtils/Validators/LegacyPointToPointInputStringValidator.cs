...
public class LegacyPointToPointInputStringValidator : LegacyInputStringInputValidator<LegacyPointToPointInputString>
{
    public LegacyPointToPointInputStringValidator()
    {
